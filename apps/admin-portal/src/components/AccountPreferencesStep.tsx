    ...
    <Card className="border-0 shadow-none">
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Controller
              ...
              render={({ field }) => (
                <RadioGroup
                  ...
                  <div className="flex items-center space-x-2 rounded-lg border p-4 transition-colors hover:bg-gray-500">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3 rounded-lg border p-4 transition-colors hover:bg-gray-500">
              <Controller
                name="newsletter"
                control={control}
                render={({ field }) => (
