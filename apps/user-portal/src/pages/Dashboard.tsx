      ...
      <section className="grid grid-cols-1  gap-4 transition-all lg:grid-cols-2">
        <DataCardContent>
          <p className="relative flex p-4 font-semibold">
            Overview
            {/* Example for conditional rendering of element having only one condition */}
            <ConditionalElement>
              <ConditionalElement.When isTrue={barLoading || barFetching}>
        ...
        <DataCardContent className="flex justify-between gap-4">
          <section>
            <p className="relative flex ">
              ...
              {/* Example for conditional rendering of element having only one condition */}
              <ConditionalElement>
                <ConditionalElement.When isTrue={salesLoading || salesFetching}>
                  <ReloadIcon className="absolute right-0 mr-2 h-4 w-4 animate-spin" />
                </ConditionalElement.When>
              </ConditionalElement>
            </p>
